...
//        findMember.setUsername("member2");
    ...
    public void specBasic() {
        ...
        // when
        Specification<Member> sp = MemberSpec.username("m1").and(MemberSpec.teamName("teamA"));// 이름 m1이면서 teamA인 것
        List<Member> result = memberRepository.findAll(sp);
    ...
    public void queryByExample() throws Exception {
        ...
        ExampleMatcher matcher = ExampleMatcher.matching()
                .withIgnorePaths("age");// age 속성은 무시

        Example<Member> example = Example.of(member, matcher);
        List<Member> result = memberRepository.findAll(example); // JpaRepository에 extends QueryByExampleExecutor가 되어있음
    ...
    public void nativeQuery() {
        ...
        Page<MemberProjection> result = memberRepository.findByNativeProjection(PageRequest.of(0, 2));
