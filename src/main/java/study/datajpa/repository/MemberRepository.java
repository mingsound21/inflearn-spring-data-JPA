...
public interface MemberRepository extends JpaRepository<Member, Long>, MemberRepositoryCustom, JpaSpecificationExecutor<Member> { // 인터페이스 상속 extends, MemberRepositoryCustom = 커스텀한 Repository 상속
